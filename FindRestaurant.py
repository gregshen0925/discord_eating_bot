...
def findRestaurant():
    ...
    if randNum<20:
        places_results = gmaps.places_nearby(location='22.9988944,120.2147295', radius = 2500, open_now =True , type = 'restaurant')
    ...
    place_details = gmaps.place(place_id= chosen_place_hash , fields= my_fields,language='zh-TW')
